...
function fraseAleatoria() {
  const fraseMotivacional = frasesMotivacionais[Math.round(Math.random() * frasesMotivacionais.length)]
  
  const fraseEmTela = document.getElementsByTagName('span')
  fraseEmTela[0].innerHTML = fraseMotivacional

  console.log(fraseEmTela)
}
